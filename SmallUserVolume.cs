...
[assembly: MelonInfo(typeof(SmallUserVolume.Main), "SmallUserVolume", "1.5", "Boppr")]
...
namespace SmallUserVolume
{
    public class Main : MelonMod
    {
        ...
        public override void OnApplicationStart()
        {
            ...
            Tiny = MelonPreferences.CreateCategory("SmallUserVolume", "Small User Volume").CreateEntry("TinyUserVolume", false, "Tiny User Volume");
        }
        public override void OnPreferencesLoaded() => MelonCoroutines.Start(CheckUIManager());
        ...
        private void OnUIInit()
        {
            ...
            else
            {
                ...
                VS.FindChild("Fill Area").FindChild("Fill").gameObject.SetActive(true);
                VS.FindChild("Background").gameObject.SetActive(true);
